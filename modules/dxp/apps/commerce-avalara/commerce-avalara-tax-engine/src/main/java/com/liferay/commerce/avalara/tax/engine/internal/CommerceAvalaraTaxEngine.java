...
public class CommerceAvalaraTaxEngine implements CommerceTaxEngine {
	...
	public static final String KEY = CommerceAvalaraConstants.KEY;
	...
	public CommerceTaxValue getCommerceTaxValue(
		...
		CommerceTaxValue commerceTaxValue =
			_commerceTaxEngine.getCommerceTaxValue(commerceTaxCalculateRequest);

		return new CommerceTaxValue(KEY, KEY, commerceTaxValue.getAmount());
	}
