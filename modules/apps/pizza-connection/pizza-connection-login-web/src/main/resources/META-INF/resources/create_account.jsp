			...
			<div class="form-group">
				...
				<clay:row>
					...
					>
						...
						<aui:input name="birthdayMonth" type="hidden" value="1" />
						<aui:input name="birthdayYear" type="hidden" value="1970" />

						<aui:input name="firstName" required="true"/>
						<aui:input name="lastName" required="true"/>

						<aui:input name="fullAddress" required="true" type="text"/>
						<aui:input name="phoneNumber" required="true" type="text"/>
					</clay:col>
