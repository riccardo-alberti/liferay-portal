...
public class Request implements Serializable {
	...
	public static Request toDTO(String json) {
		return ObjectMapperUtil.readValue(Request.class, json);
	}

	public static Request unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Request.class, json);
	}
	...
	public String toString() {
		...
		if (inputParameters != null) {
			...
			for (int i = 0; i < inputParameters.length; i++) {
				sb.append(String.valueOf(inputParameters[i]));

				if ((i + 1) < inputParameters.length) {
					sb.append(", ");
				}
			}
		...
		if (outputParameters != null) {
			...
			for (int i = 0; i < outputParameters.length; i++) {
				sb.append(String.valueOf(outputParameters[i]));

				if ((i + 1) < outputParameters.length) {
					sb.append(", ");
				}
			}
		...
		if (tasks != null) {
			...
			for (int i = 0; i < tasks.length; i++) {
				sb.append(String.valueOf(tasks[i]));
		...
		if (workflowDefinition != null) {
			...
			sb.append(_escape(workflowDefinition));
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.fulfilment.admin.dto.v1_0.Request",
		name = "x-class-name"
	)
