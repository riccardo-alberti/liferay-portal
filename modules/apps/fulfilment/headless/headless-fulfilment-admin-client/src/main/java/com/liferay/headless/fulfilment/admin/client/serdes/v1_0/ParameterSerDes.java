...
public class ParameterSerDes {
	...
	public static String toJSON(Parameter parameter) {
		...
		if (parameter.getKey() != null) {
			...
			sb.append(_escape(parameter.getKey()));
	...
	public static Map<String, String> toMap(Parameter parameter) {
		...
		if (parameter.getKey() == null) {
			...
			map.put("key", String.valueOf(parameter.getKey()));
		}
		...
		if (parameter.getValue() == null) {
			...
			map.put("value", String.valueOf(parameter.getValue()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "key")) {
				if (jsonParserFieldValue != null) {
					parameter.setKey((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "value")) {
				if (jsonParserFieldValue != null) {
					parameter.setValue((Object)jsonParserFieldValue);
				}
			}
		}
