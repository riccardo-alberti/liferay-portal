...
public interface TaskResource {
	...
	public HttpInvoker.HttpResponse
			getRequestByExternalReferenceCodeTasksPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getRequestIdTasksPageHttpResponse(
	...
	public static class TaskResourceImpl implements TaskResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-fulfilment-admin/v1.0/requests/by-externalReferenceCode/{externalReferenceCode}/tasks");
		...
		public Page<Task> getRequestIdTasksPage(Long id, Pagination pagination)
			...
			HttpInvoker.HttpResponse httpResponse =
				getRequestIdTasksPageHttpResponse(id, pagination);
		...
		public HttpInvoker.HttpResponse getRequestIdTasksPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-fulfilment-admin/v1.0/requests/{id}/tasks");
