...
public class FulfilmentRequestModelIndexerWriterContributor
	implements ModelIndexerWriterContributor<FulfilmentRequest> {
	...
	public BatchIndexingActionable getBatchIndexingActionable() {
		return _dynamicQueryBatchIndexingActionableFactory.
			getBatchIndexingActionable(
				_fulfilmentRequestLocalService.
					getIndexableActionableDynamicQuery());
	}

	@Override
	public long getCompanyId(FulfilmentRequest fulfilmentRequest) {
		return fulfilmentRequest.getCompanyId();
	}
