...
@Component(
	immediate = true,
	property = "clay.data.set.display.name=" + FulfilmentDataSetConstants.FULFILMENT_REQUEST_DATA_SET_KEY,
	service = ClayDataSetDisplayView.class
)
public class FulfilmentRequestAdminClayTableDataSetDisplayView
	...
	public ClayTableSchema getClayTableSchema() {
		...
		ClayTableSchemaField nameClayTableSchemaField =
			clayTableSchemaBuilder.addClayTableSchemaField("id", "request-id");

		nameClayTableSchemaField.setContentRenderer("actionLink");

		clayTableSchemaBuilder.addClayTableSchemaField("type", "type");

		clayTableSchemaBuilder.addClayTableSchemaField("replyTo", "reply-to");
