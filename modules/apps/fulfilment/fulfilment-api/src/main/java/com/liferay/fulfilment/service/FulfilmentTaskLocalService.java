...
/**
 * Provides the local service interface for FulfilmentTask. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Riccardo Alberti
 * @see FulfilmentTaskLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FulfilmentTaskLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.fulfilment.service.impl.FulfilmentTaskLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fulfilment task local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FulfilmentTaskLocalServiceUtil} if injection and service tracking are not available.
	 */
