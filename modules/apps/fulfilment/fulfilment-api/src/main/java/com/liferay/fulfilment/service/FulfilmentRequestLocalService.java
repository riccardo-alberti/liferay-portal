...
/**
 * Provides the local service interface for FulfilmentRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Riccardo Alberti
 * @see FulfilmentRequestLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FulfilmentRequestLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.fulfilment.service.impl.FulfilmentRequestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fulfilment request local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FulfilmentRequestLocalServiceUtil} if injection and service tracking are not available.
	 */
