...
@Component(
	...
	property = {
		"commerce.engine.task.key=" + OpenCommerceEngineTaskImpl.KEY,
		"commerce.engine.task.priority:Integer=" + OpenCommerceEngineTaskImpl.PRIORITY,
		"commerce.engine.task.type=" + OpenCommerceEngineTaskImpl.TYPE
	},
	service = CommerceEngineTask.class
)
public class OpenCommerceEngineTaskImpl implements CommerceEngineTask {
