...
@Component(
	...
	property = {
		"commerce.engine.task.key=" + CompletedCommerceEngineTaskImpl.KEY,
		"commerce.engine.task.priority:Integer=" + CompletedCommerceEngineTaskImpl.PRIORITY,
		"commerce.engine.task.type=" + CompletedCommerceEngineTaskImpl.TYPE
	},
	service = CommerceEngineTask.class
)
public class CompletedCommerceEngineTaskImpl implements CommerceEngineTask {

	public static final String KEY = "completed";
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompletedCommerceEngineTaskImpl.class);
