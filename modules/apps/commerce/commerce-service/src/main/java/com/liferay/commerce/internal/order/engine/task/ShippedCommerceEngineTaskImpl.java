...
@Component(
	...
	property = {
		"commerce.engine.task.key=" + ShippedCommerceEngineTaskImpl.KEY,
		"commerce.engine.task.priority:Integer=" + ShippedCommerceEngineTaskImpl.PRIORITY,
		"commerce.engine.task.type=" + ShippedCommerceEngineTaskImpl.TYPE
	},
	service = CommerceEngineTask.class
)
public class ShippedCommerceEngineTaskImpl implements CommerceEngineTask {

	public static final String KEY = "shipped";
	...
	public void execute(Map<String, Object> context) throws Exception {
		...
		if (!_commerceShippingHelper.isShippable(commerceOrder)) {
			Map<String, Object> completed = _commerceEngine.executeTask(
				context, "completed", "order-engine");

			commerceOrder = (CommerceOrder)completed.get("_commerceOrder");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ShippedCommerceEngineTaskImpl.class);
