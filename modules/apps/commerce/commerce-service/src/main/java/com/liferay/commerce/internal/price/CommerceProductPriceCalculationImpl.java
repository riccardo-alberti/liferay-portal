...
public class CommerceProductPriceCalculationImpl
	...
	public CommerceProductPrice getCommerceProductPrice(
		...
		productPriceCommerceEngineTaskContext.setCpInstanceId(
			commerceProductPriceRequest.getCpInstanceId());
		productPriceCommerceEngineTaskContext.setQuantity(
			commerceProductPriceRequest.getQuantity());
		productPriceCommerceEngineTaskContext.setCommerceContext(
			commerceContext);
		productPriceCommerceEngineTaskContext.setCommerceOptionValues(
			commerceProductPriceRequest.getCommerceOptionValues());

		try {
			_commerceEngine.executeTasks(
				commerceContext.getCommerceChannelGroupId(), "product-pricing",
				productPriceCommerceEngineTaskContext);
		}
	...
	private CommerceProductPriceImpl _getCommerceProductPriceImpl(
		...
		commerceProductPriceImpl.setUnitPromoPrice(
			_commerceMoneyFactory.create(
				commerceCurrency,
				productPriceCommerceEngineTaskContext.getPromoPrice()));
		commerceProductPriceImpl.setUnitPromoPriceWithTaxAmount(
			_commerceMoneyFactory.create(
				commerceCurrency,
				productPriceCommerceEngineTaskContext.
		...
		commerceProductPriceImpl.setCommercePriceListId(
			productPriceCommerceEngineTaskContext.
				getFinalCommercePriceListId());
		commerceProductPriceImpl.setCommerceDiscountValue(
			productPriceCommerceEngineTaskContext.getCommerceDiscountValue());
		commerceProductPriceImpl.setCommerceDiscountValueWithTaxAmount(
			productPriceCommerceEngineTaskContext.
				getCommerceDiscountValueWithTaxAmount());
