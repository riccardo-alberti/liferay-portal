...
@Component(
	...
	property = {
		"commerce.engine.task.key=" + PartiallyShippedCommerceEngineTaskImpl.KEY,
		"commerce.engine.task.priority:Integer=" + PartiallyShippedCommerceEngineTaskImpl.PRIORITY,
		"commerce.engine.task.type=" + PartiallyShippedCommerceEngineTaskImpl.TYPE
	},
	service = CommerceEngineTask.class
)
public class PartiallyShippedCommerceEngineTaskImpl
	implements CommerceEngineTask {

	public static final String KEY = "partially-shipped";
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PartiallyShippedCommerceEngineTaskImpl.class);
