...
public class PriceCommerceEngineTasksScreenNavigationCategory
	implements ScreenNavigationCategory,
			   ScreenNavigationEntry<CommerceChannel> {

	@Override
	public String getCategoryKey() {
		return "price-commerce-engine-tasks";
	}
	...
	public void render(
		...
		_jspRenderer.renderJSP(
			...
			"/price_commerce_engine_tasks" +
				"/view_price_commerce_engine_tasks.jsp");
	}
