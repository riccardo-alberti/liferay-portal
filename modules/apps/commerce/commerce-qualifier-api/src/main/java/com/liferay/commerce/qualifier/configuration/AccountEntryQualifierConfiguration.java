...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.AccountEntryQualifierConfiguration",
	localization = "content/Language",
	name = "account-entry-qualifier-configuration-name"
)
public interface AccountEntryQualifierConfiguration
