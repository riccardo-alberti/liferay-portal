...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.AddressQualifierConfiguration",
	localization = "content/Language",
	name = "address-qualifier-configuration-name"
)
public interface AddressQualifierConfiguration
