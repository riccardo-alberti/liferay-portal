...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.COREntryQualifierConfiguration",
	localization = "content/Language",
	name = "commerce-order-rule-qualifier-configuration-name"
)
public interface COREntryQualifierConfiguration
