...
import com.liferay.commerce.qualifier.configuration.CommerceTermEntryQualifierConfiguration;
 ...
 */
@Component(
	configurationPid = "com.liferay.commerce.qualifier.configuration.CommerceTermEntryQualifierConfiguration",
	enabled = false, immediate = true,
	service = {CommerceQualifierMetadata.class, ModelListener.class}
)
public class CommerceDeliveryTermQualifierMetadata
	extends BaseCommerceQualifierMetadata<CommerceTermEntry> {

	@Override
	public Class<?> getConfigurationBeanClass() {
		return CommerceTermEntryQualifierConfiguration.class;
	}
