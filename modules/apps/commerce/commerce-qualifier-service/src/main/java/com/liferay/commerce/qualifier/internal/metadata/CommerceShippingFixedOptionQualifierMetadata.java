...
import com.liferay.commerce.qualifier.configuration.CommerceShippingFixedOptionQualifierConfiguration;
 ...
 */
@Component(
	configurationPid = "com.liferay.commerce.qualifier.configuration.CommerceShippingFixedOptionQualifierConfiguration",
	enabled = false, immediate = true,
	service = {CommerceQualifierMetadata.class, ModelListener.class}
)
public class CommerceShippingFixedOptionQualifierMetadata
	extends BaseCommerceQualifierMetadata<CommerceShippingFixedOption> {

	@Override
	public Class<?> getConfigurationBeanClass() {
		return CommerceShippingFixedOptionQualifierConfiguration.class;
	}
