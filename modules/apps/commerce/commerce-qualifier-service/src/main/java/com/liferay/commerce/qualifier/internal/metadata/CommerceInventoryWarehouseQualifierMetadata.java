...
import com.liferay.commerce.qualifier.configuration.CommerceInventoryWarehouseQualifierConfiguration;
 ...
 */
@Component(
	configurationPid = "com.liferay.commerce.qualifier.configuration.CommerceInventoryWarehouseQualifierConfiguration",
	enabled = false, immediate = true,
	service = {CommerceQualifierMetadata.class, ModelListener.class}
)
public class CommerceInventoryWarehouseQualifierMetadata
	extends BaseCommerceQualifierMetadata<CommerceInventoryWarehouse> {

	@Override
	public Class<?> getConfigurationBeanClass() {
		return CommerceInventoryWarehouseQualifierConfiguration.class;
	}
