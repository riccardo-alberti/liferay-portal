...
import com.liferay.commerce.qualifier.configuration.COREntryQualifierConfiguration;
 ...
 */
@Component(
	configurationPid = "com.liferay.commerce.qualifier.configuration.COREntryQualifierConfiguration",
	enabled = false, immediate = true,
	service = {CommerceQualifierMetadata.class, ModelListener.class}
)
public class CommerceOrderRuleQualifierMetadata
	extends BaseCommerceQualifierMetadata<COREntry> {

	@Override
	public Class<?> getConfigurationBeanClass() {
		return COREntryQualifierConfiguration.class;
	}
