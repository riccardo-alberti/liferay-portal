...
import com.liferay.commerce.qualifier.configuration.CommercePaymentMethodGroupRelQualifierConfiguration;
 ...
 */
@Component(
	configurationPid = "com.liferay.commerce.qualifier.configuration.CommercePaymentMethodGroupRelQualifierConfiguration",
	enabled = false, immediate = true,
	service = {CommerceQualifierMetadata.class, ModelListener.class}
)
public class CommercePaymentMethodGroupRelQualifierMetadata
	extends BaseCommerceQualifierMetadata<CommercePaymentMethodGroupRel> {

	@Override
	public Class<?> getConfigurationBeanClass() {
		return CommercePaymentMethodGroupRelQualifierConfiguration.class;
	}
