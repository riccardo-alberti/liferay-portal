...
public class DiscountOrderTypeResourceImpl
	...
	public Page<DiscountOrderType>
		...
		List<CommerceDiscountOrderTypeRel> commerceDiscountOrderTypeRels =
			_commerceDiscountOrderTypeRelService.
				getCommerceDiscountOrderTypeRels(
					commerceDiscount.getCommerceDiscountId(), StringPool.BLANK,
		...
		return Page.of(
			_toDiscountOrderTypes(commerceDiscountOrderTypeRels), pagination,
			totalItems);
	}
	...
	private List<DiscountOrderType> _toDiscountOrderTypes(
			List<CommerceDiscountOrderTypeRel> commerceDiscountOrderTypeRels)
		throws Exception {

		List<DiscountOrderType> discountOrderTypes = new ArrayList<>();

		for (CommerceDiscountOrderTypeRel commerceDiscountOrderTypeRel :
				commerceDiscountOrderTypeRels) {

			discountOrderTypes.add(
				_toDiscountOrderType(
					commerceDiscountOrderTypeRel.
						getCommerceDiscountOrderTypeRelId()));
		}
