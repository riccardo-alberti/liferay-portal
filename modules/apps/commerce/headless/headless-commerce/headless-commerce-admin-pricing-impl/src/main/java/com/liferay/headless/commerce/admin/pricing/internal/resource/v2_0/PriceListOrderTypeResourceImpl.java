...
public class PriceListOrderTypeResourceImpl
	...
	public Page<PriceListOrderType>
		...
		return Page.of(
			_toPriceListOrderTypes(commercePriceListOrderTypeRels), pagination,
			totalItems);
	}
	...
	private List<PriceListOrderType> _toPriceListOrderTypes(
		...
		List<PriceListOrderType> priceListOrderTypes = new ArrayList<>();

		for (CommercePriceListOrderTypeRel commercePriceListOrderTypeRel :
				commercePriceListOrderTypeRels) {

			priceListOrderTypes.add(
				_toPriceListOrderType(
					commercePriceListOrderTypeRel.
						getCommercePriceListOrderTypeRelId()));
		}
