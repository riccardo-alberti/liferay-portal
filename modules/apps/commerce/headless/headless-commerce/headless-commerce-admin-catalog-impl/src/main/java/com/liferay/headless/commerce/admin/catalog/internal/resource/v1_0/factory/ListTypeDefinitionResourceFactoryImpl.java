 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-catalog/v1.0/ListTypeDefinition",
...
public class ListTypeDefinitionResourceFactoryImpl
	...
	public ListTypeDefinitionResource.Builder create() {
		return new ListTypeDefinitionResource.Builder() {
			...
			public ListTypeDefinitionResource build() {
				...
				Function<InvocationHandler, ListTypeDefinitionResource>
					listTypeDefinitionResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_listTypeDefinitionResourceProxyProviderFunction;

				return listTypeDefinitionResourceProxyProviderFunction.apply(
			...
			@Override
			public ListTypeDefinitionResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, ListTypeDefinitionResource>
				_listTypeDefinitionResourceProxyProviderFunction =
					_getProxyProviderFunction();
