 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-channel/v1.0/CategoryDisplayPage",
	service = CategoryDisplayPageResource.Factory.class
)
@Generated("")
public class CategoryDisplayPageResourceFactoryImpl
	implements CategoryDisplayPageResource.Factory {

	@Override
	public CategoryDisplayPageResource.Builder create() {
		return new CategoryDisplayPageResource.Builder() {
			...
			public CategoryDisplayPageResource build() {
				...
				Function<InvocationHandler, CategoryDisplayPageResource>
					categoryDisplayPageResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_categoryDisplayPageResourceProxyProviderFunction;

				return categoryDisplayPageResourceProxyProviderFunction.apply(
			...
			@Override
			public CategoryDisplayPageResource.Builder checkPermissions(
			...
			@Override
			public CategoryDisplayPageResource.Builder httpServletRequest(
			...
			@Override
			public CategoryDisplayPageResource.Builder httpServletResponse(
			...
			@Override
			public CategoryDisplayPageResource.Builder preferredLocale(
			...
			@Override
			public CategoryDisplayPageResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public CategoryDisplayPageResource.Builder user(User user) {
				_user = user;
	...
	private static Function<InvocationHandler, CategoryDisplayPageResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			CategoryDisplayPageResource.class.getClassLoader(),
			CategoryDisplayPageResource.class);

		try {
			Constructor<CategoryDisplayPageResource> constructor =
				(Constructor<CategoryDisplayPageResource>)
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(categoryDisplayPageResource);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function
			<InvocationHandler, CategoryDisplayPageResource>
				_categoryDisplayPageResourceProxyProviderFunction =
					_getProxyProviderFunction();
