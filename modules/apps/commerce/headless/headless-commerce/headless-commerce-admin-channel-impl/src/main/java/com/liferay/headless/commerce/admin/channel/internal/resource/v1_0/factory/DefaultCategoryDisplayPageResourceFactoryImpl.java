 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-channel/v1.0/DefaultCategoryDisplayPage",
	service = DefaultCategoryDisplayPageResource.Factory.class
)
@Generated("")
public class DefaultCategoryDisplayPageResourceFactoryImpl
	implements DefaultCategoryDisplayPageResource.Factory {

	@Override
	public DefaultCategoryDisplayPageResource.Builder create() {
		return new DefaultCategoryDisplayPageResource.Builder() {
			...
			public DefaultCategoryDisplayPageResource build() {
				...
				Function<InvocationHandler, DefaultCategoryDisplayPageResource>
					defaultCategoryDisplayPageResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_defaultCategoryDisplayPageResourceProxyProviderFunction;

				return defaultCategoryDisplayPageResourceProxyProviderFunction.
					apply(
			...
			@Override
			public DefaultCategoryDisplayPageResource.Builder checkPermissions(
			...
			@Override
			public DefaultCategoryDisplayPageResource.Builder
			...
			@Override
			public DefaultCategoryDisplayPageResource.Builder preferredLocale(
			...
			@Override
			public DefaultCategoryDisplayPageResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public DefaultCategoryDisplayPageResource.Builder user(User user) {
				_user = user;
	...
	private static Function
		<InvocationHandler, DefaultCategoryDisplayPageResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			DefaultCategoryDisplayPageResource.class.getClassLoader(),
			DefaultCategoryDisplayPageResource.class);

		try {
			Constructor<DefaultCategoryDisplayPageResource> constructor =
				(Constructor<DefaultCategoryDisplayPageResource>)
