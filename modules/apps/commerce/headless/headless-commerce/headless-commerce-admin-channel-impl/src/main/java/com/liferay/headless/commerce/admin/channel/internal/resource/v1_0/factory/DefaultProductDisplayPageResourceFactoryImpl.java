 ...
 */
@Component(
	property = "resource.locator.key=/headless-commerce-admin-channel/v1.0/DefaultProductDisplayPage",
	service = DefaultProductDisplayPageResource.Factory.class
)
@Generated("")
public class DefaultProductDisplayPageResourceFactoryImpl
	implements DefaultProductDisplayPageResource.Factory {

	@Override
	public DefaultProductDisplayPageResource.Builder create() {
		return new DefaultProductDisplayPageResource.Builder() {
			...
			public DefaultProductDisplayPageResource build() {
				...
				Function<InvocationHandler, DefaultProductDisplayPageResource>
					defaultProductDisplayPageResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_defaultProductDisplayPageResourceProxyProviderFunction;

				return defaultProductDisplayPageResourceProxyProviderFunction.
					apply(
			...
			@Override
			public DefaultProductDisplayPageResource.Builder checkPermissions(
			...
			@Override
			public DefaultProductDisplayPageResource.Builder httpServletRequest(
			...
			@Override
			public DefaultProductDisplayPageResource.Builder
			...
			@Override
			public DefaultProductDisplayPageResource.Builder preferredLocale(
			...
			@Override
			public DefaultProductDisplayPageResource.Builder uriInfo(
				UriInfo uriInfo) {
			...
			@Override
			public DefaultProductDisplayPageResource.Builder user(User user) {
				_user = user;
	...
	private static Function
		<InvocationHandler, DefaultProductDisplayPageResource>
			_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			DefaultProductDisplayPageResource.class.getClassLoader(),
			DefaultProductDisplayPageResource.class);

		try {
			Constructor<DefaultProductDisplayPageResource> constructor =
				(Constructor<DefaultProductDisplayPageResource>)
