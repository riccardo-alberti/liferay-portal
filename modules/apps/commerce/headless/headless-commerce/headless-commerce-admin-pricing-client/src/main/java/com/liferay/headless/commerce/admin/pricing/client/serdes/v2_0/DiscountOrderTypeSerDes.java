...
public class DiscountOrderTypeSerDes {
	...
	public static String toJSON(DiscountOrderType discountOrderType) {
		...
		if (discountOrderType.getOrder() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(discountOrderType.getOrder());
		}
	...
	public static Map<String, String> toMap(
		...
		if (discountOrderType.getOrder() == null) {
			...
			map.put("order", String.valueOf(discountOrderType.getOrder()));
		}
