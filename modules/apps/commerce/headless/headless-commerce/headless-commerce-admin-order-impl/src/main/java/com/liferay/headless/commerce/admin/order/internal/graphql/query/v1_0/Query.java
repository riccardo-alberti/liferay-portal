...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {orderByExternalReferenceCodeOrderType(externalReferenceCode: ___){actions, active, customFields, description, displayDate, displayOrder, expirationDate, externalReferenceCode, id, name, neverExpire, orderTypeChannels, workflowStatusInfo}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public OrderType orderByExternalReferenceCodeOrderType(
			@GraphQLName("externalReferenceCode") String externalReferenceCode)
		throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {orderIdOrderType(id: ___){actions, active, customFields, description, displayDate, displayOrder, expirationDate, externalReferenceCode, id, name, neverExpire, orderTypeChannels, workflowStatusInfo}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public OrderType orderIdOrderType(@GraphQLName("id") Long id)
		throws Exception {

		return _applyComponentServiceObjects(
			_orderTypeResourceComponentServiceObjects,
			this::_populateResourceContext,
			orderTypeResource -> orderTypeResource.getOrderIdOrderType(id));
	}
	...
	@GraphQLTypeExtension(Order.class)
	public class GetOrderByExternalReferenceCodeOrderTypeTypeExtension {

		public GetOrderByExternalReferenceCodeOrderTypeTypeExtension(
			Order order) {
		...
		@GraphQLField
		public OrderType byExternalReferenceCodeOrderType() throws Exception {
			return _applyComponentServiceObjects(
				_orderTypeResourceComponentServiceObjects,
				Query.this::_populateResourceContext,
				orderTypeResource ->
