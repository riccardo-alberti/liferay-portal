...
@Component(
	...
	property = {
		"segments.field.customizer.entity.name=CommerceAccountGroup",
		"segments.field.customizer.key=" + CommerceAccountGroupSegmentsFieldCustomizer.KEY,
		"segments.field.customizer.priority:Integer=900"
	},
	service = SegmentsFieldCustomizer.class
)
public class CommerceAccountGroupSegmentsFieldCustomizer
	implements SegmentsFieldCustomizer {

	public static final String KEY = "commerceAccountGroup";

	@Override
	public ClassedModel getClassedModel(String fieldValue) {
		return _getCommerceAccountGroup(fieldValue);
	}
	...
	public Field.SelectEntity getSelectEntity(PortletRequest portletRequest) {
		try {
			...
			portletURL.setParameter(
				...
				"/segments/select_commerce_account_groups");
	...
	private CommerceAccountGroup _getCommerceAccountGroup(String fieldValue) {
		long commerceAccountGroupId = GetterUtil.getLong(fieldValue);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommerceAccountGroupSegmentsFieldCustomizer.class);
