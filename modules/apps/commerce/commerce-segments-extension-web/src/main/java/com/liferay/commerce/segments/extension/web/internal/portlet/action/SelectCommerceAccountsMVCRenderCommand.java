...
import com.liferay.commerce.segments.extension.web.internal.display.context.SelectCommerceAccountsDisplayContext;
import com.liferay.commerce.segments.extension.web.internal.display.context.SelectCommerceAccountsManagementToolbarDisplayContext;
...
@Component(
	...
	property = {
		...
		"mvc.command.name=/segments/select_commerce_accounts"
	},
	service = MVCRenderCommand.class
)
public class SelectCommerceAccountsMVCRenderCommand
	...
	public String render(
		...
		RequestDispatcher requestDispatcher =
			_servletContext.getRequestDispatcher(
				"/field/select_commerce_accounts.jsp");
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SelectCommerceAccountsMVCRenderCommand.class);
