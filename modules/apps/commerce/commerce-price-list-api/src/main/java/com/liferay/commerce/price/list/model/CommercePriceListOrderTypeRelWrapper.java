...
public class CommercePriceListOrderTypeRelWrapper
	...
	/**
	 * Returns the order of this commerce price list order type rel.
	 *
	 * @return the order of this commerce price list order type rel
	 */
	@Override
	public int getOrder() {
	...
	/**
	 * Sets the order of this commerce price list order type rel.
	 *
	 * @param order the order of this commerce price list order type rel
	 */
	@Override
