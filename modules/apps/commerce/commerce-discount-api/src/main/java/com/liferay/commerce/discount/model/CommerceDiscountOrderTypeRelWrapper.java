...
public class CommerceDiscountOrderTypeRelWrapper
	...
	/**
	 * Returns the order of this commerce discount order type rel.
	 *
	 * @return the order of this commerce discount order type rel
	 */
	@Override
	public int getOrder() {
	...
	/**
	 * Sets the order of this commerce discount order type rel.
	 *
	 * @param order the order of this commerce discount order type rel
	 */
	@Override
