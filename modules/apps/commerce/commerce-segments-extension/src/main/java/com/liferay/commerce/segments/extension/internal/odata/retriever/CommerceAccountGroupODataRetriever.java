...
public class CommerceAccountGroupODataRetriever
	implements ODataRetriever<CommerceAccountGroup> {

	@Override
	public List<CommerceAccountGroup> getResults(
		...
		Hits hits = _oDataSearchAdapter.search(
			...
			CommerceAccountGroup.class.getName(), _entityModel, locale, start,
			end);

		return _getCommerceAccountGroups(hits);
	}
	...
	public int getResultsCount(
		...
		return _oDataSearchAdapter.searchCount(
			companyId, _getFilterParser(), filterString,
			CommerceAccountGroup.class.getName(), _entityModel, locale);
	}

	private CommerceAccountGroup _getCommerceAccountGroup(Document document)
		throws PortalException {
	...
	private List<CommerceAccountGroup> _getCommerceAccountGroups(Hits hits)
		throws PortalException {
		...
		for (Document document : documents) {
			commerceAccountGroups.add(_getCommerceAccountGroup(document));
		}
