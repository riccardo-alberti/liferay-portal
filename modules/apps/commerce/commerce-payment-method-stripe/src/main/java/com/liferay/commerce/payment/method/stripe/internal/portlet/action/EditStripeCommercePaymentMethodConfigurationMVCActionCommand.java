...
package com.liferay.commerce.payment.method.stripe.internal.portlet.action;
...
@Component(
	...
	property = {
		...
		"mvc.command.name=/commerce_payment_methods/edit_stripe_commerce_payment_method_configuration"
	},
...
public class EditStripeCommercePaymentMethodConfigurationMVCActionCommand
	...
	private void _updateCommercePaymentMethod(ActionRequest actionRequest)
		...
		String publicKey = ParamUtil.getString(actionRequest, "public-key");

		modifiableSettings.setValue("publicKey", publicKey);

		String secretKey = ParamUtil.getString(actionRequest, "secret-key");
