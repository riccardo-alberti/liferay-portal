...
public class CommercePriceListOrderTypeRelPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new CommercePriceListOrderTypeRelModelArgumentsResolver(),
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(
		new String[] {"uuid", "commercePriceListOrderTypeRelId", "order"});
	...
	private static class CommercePriceListOrderTypeRelModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					commercePriceListOrderTypeRelModelImpl, columnNames,
					original);
			}
