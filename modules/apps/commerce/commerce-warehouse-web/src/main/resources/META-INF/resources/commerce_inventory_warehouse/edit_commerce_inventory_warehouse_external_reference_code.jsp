...
<%
CommerceInventoryWarehousesDisplayContext commerceOrderTypeDisplayContext = (CommerceInventoryWarehousesDisplayContext)request.getAttribute(WebKeys.PORTLET_DISPLAY_CONTEXT);

CommerceInventoryWarehouse commerceInventoryWarehouse = commerceOrderTypeDisplayContext.getCommerceInventoryWarehouse();
%>
