 ...
 * @generated
 */
public class CommercePaymentMethodGroupRelFinderBaseImpl
	extends BasePersistenceImpl<CommercePaymentMethodGroupRel> {

	public CommercePaymentMethodGroupRelFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return getCommercePaymentMethodGroupRelPersistence().
			getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CommercePaymentMethodGroupRelFinderBaseImpl.class);
